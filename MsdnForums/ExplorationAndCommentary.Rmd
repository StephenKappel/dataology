...
```{r forums.hist, fig.width=5.5, fig.height=4}
...
```{r forums.hist2, fig.width=5.5, fig.height=4}
...
```{r forums.hist3, fig.width=5.5, fig.height=4}
...
```{r forums.scatter, fig.width=5.5, fig.height=4}
...
```{r threads.hist.success, fig.width=5.5, fig.height=4}
# create ggplot2 object
...
```{r threads.hist.success.sql.sp, fig.width=5.5, fig.height=4}
...
```{r threads.ttfa.day, fig.width=5.5, fig.height=4}
for (day in 1:7)
{
...
```{r threads.hist.other, fig.width=5.5, fig.height=4}
...
```{r threads.hist.part, fig.width=5.5, fig.height=4}
# MSFT histogram
...
```{r threads.hist.other2, fig.width=5.5, fig.height=4}
# asker points
...
```{r threads.msft, fig.width=5.5, fig.height=4}
...
```{r thread.length, fig.width=5.5, fig.height=4}
...
```{r thead.created, fig.width=5.5, fig.height=4}
...
```{r thead.msft, fig.width=5.5, fig.height=4}
...
```{r thread.length.succ, fig.width=5.5, fig.height=4}
# By month
...
```{r success.tree, fig.width=5.5, fig.height=4}
library(party)
...
```{r success.tree2, fig.width=5.5, fig.height=4}
# fit the tree
...
```{r success.tree.diagram, fig.width=11, fig.height=9}
# view the tree
plot(success.tree)
...
```{r fit.logit , fig.width=5.5, fig.height=4}
...
```{r data.split.logit2 , fig.width=5.5, fig.height=4}
